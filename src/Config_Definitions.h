...
#define BUTTON_PRESET2_GPIO 19
#define BUTTON_MOD_GPIO 19

#define BUTTON_PRESET3_GPIO 18
#define BUTTON_DELAY_GPIO 18
...
// LED GPIOs
#define LED_PRESET1_GPIO 16
#define LED_DRIVE_GPIO 16
